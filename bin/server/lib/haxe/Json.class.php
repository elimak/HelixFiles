...
class haxe_Json {
	...
	public function invalidChar() {
		$this->pos--;
		throw new HException("Invalid char " . ord(substr($this->str,$this->pos,1)) . " at position " . $this->pos);
	}
		...
		while(true) {
			...
			case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 45:{
				...
				if(!$this->reg_float->match(_hx_substr($this->str, $this->pos, null))) {
					throw new HException("Invalid float at position " . $this->pos);
				}
	...
	public function parseString() {
		...
		while(true) {
			...
			if($c === 92) {
				...
				default:{
					throw new HException("Invalid escape sequence \\" . chr($c) . " at position " . ($this->pos - 1));
				}break;
				}
				$start = $this->pos;
			} else {
